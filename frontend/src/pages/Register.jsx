    ...
    return (
        <div className="min-h-screen bg-[#050505] bg-[radial-gradient(circle_at_20%_0%,#141414_0%,#050505_65%)] font-inter text-white flex items-center justify-center px-4 py-14">
            ...
            <div className="pointer-events-none fixed inset-0 overflow-hidden">
                <div className="absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full bg-[#d4af37]/[0.06] blur-3xl" />
                <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full bg-[#d4af37]/[0.04] blur-3xl" />
            </div>
            ...
            <div className="relative w-full max-w-md">
                ...
                <header className="text-center mb-10">
                    ...
                    <p className="text-sm text-[#c9c0ae]">
                        Claim your seat at the golden table.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="relative space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <FaUser className="absolute left-4 top-1/2 -translate-y-1/2 text-[#d4af37] text-sm pointer-events-none" />
                                <input
                                    id="username"
                                    type="text"
                                    name="username"
